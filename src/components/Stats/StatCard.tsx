    ...
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-4">
      ...
      <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
        <div>
          ...
          <p className="font-semibold text-gray-900 dark:text-white">{fmt(stat.sum)}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Promedio</span>
          <p className="font-semibold text-gray-900 dark:text-white">{fmt(stat.mean)}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Mín</span>
          <p className="font-semibold text-gray-900 dark:text-white">{fmt(stat.min)}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Máx</span>
          <p className="font-semibold text-gray-900 dark:text-white">{fmt(stat.max)}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Mediana</span>
          <p className="font-semibold text-gray-900 dark:text-white">{fmt(stat.median)}</p>
        </div>
        <div>
          <span className="text-gray-400 dark:text-gray-500">Registros</span>
          <p className="font-semibold text-gray-900 dark:text-white">{stat.count}</p>
        </div>
      </div>
    </div>
  );
