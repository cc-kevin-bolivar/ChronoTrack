    ...
    <aside className="w-56 bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 flex flex-col h-screen sticky top-0">
      ...
      <div className="px-5 py-5 border-b border-gray-100 dark:border-gray-800">
        <div className="flex items-center gap-2.5">
          ...
          <span className="text-lg font-bold text-gray-900 dark:text-white">ChronoTrack</span>
        </div>
      </div>
          ...
          return (
            <button
              ...
              className={`
                ...
                ${isActive
                  ? 'bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-400 border-l-3 border-blue-600'
